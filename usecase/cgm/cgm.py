...
axs[2].set_ylabel('Glucose (mg/dL)', fontsize=LABEL_FONT)
...
axs[3].set_ylabel('Glucose (mg/dL)', fontsize=LABEL_FONT)
...
fig.savefig('fig/figure_cgm.pdf',
            dpi=DPI, bbox_inches='tight')
fig.savefig('fig/figure_cgm.png',
            dpi=DPI, bbox_inches='tight')
